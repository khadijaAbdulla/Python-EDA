...
### Overview
Analysis for 1130 US movies, 15 columns, from 1920 until 2024. <br>
...
![correlation between the runtime and the rating of a movie](resources/2.png) <br>
...
![number of movies per category](resources/3.png) <br>
Drama, Comedy, and Documentary are the top three categories, followed by action, horror and crime.

##### 5. What is the average runtime per category?
![average runtime per category](resources/4.png) <br>
...
##### 6. What is the average rating per category?
![average rating per category](resources/5.png) <br>
